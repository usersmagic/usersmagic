    ...
    if (!req.query.is_private_campaign) {
      Campaign.findOne({$and: [
        ...
        User.findByIdAndUpdate(mongoose.Types.ObjectId(req.session.user._id), {
          ...
          $set: {
            ["campaign_status." + campaign._id.toString()]: "saved",
            ["campaign_versions." + campaign._id.toString()]: campaign.version_number,
            ["campaign_last_question." + campaign._id.toString()]: -1
          }
        }, {}, err => {
